...
| attrid | typeid                    | 说明                                                     |
| ------ | ------------------------- | -------------------------------------------------------- |
| 200    | PROTOCOL_PROP_TYPE_STRING | 模组信息，以字符串表示：“XXXX.YYYY.ZZZZ”，固定长度14字节 |
| 201    | PROTOCOL_PROP_TYPE_UINT8  | 模组网络状态，见**模组网络状态定义**                     |
| 202    | PROTOCOL_PROP_TYPE_UINT8  | 使能配网                                                 |
| 203    | PROTOCOL_PROP_TYPE_UINT8  | 设备快照                                                 |
| 204    | PROTOCOL_PROP_TYPE_UINT8  | 心跳                                                     |
| 210    | PROTOCOL_PROP_TYPE_UINT32 | 米家pid                                                  |
| 211    | PROTOCOL_PROP_TYPE_STRING | 米家model                                                |
| 212    | PROTOCOL_PROP_TYPE_STRING | 米家mcu version                                          |
...
| PROTOCOL_PROP_TYPE_INT8（有符号8位整型、枚举） | 1    |
| PROTOCOL_PROP_TYPE_UINT8（无符号8位整型）      | 2    |
